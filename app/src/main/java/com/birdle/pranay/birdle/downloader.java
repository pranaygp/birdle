...
//        new downloadFile(getApplicationContext()).execute();
    ...
    private void updateProgress(int currentSize, int totalSize)
    {
    ...
    private SharedPreferences getGCMPreferences(Context context) {
        ...
        return getSharedPreferences(downloader.class.getSimpleName(),
    ...
    */
    ...
    private void sendRegistrationIdToBackend() {
        ...
        HttpPost httppost = new HttpPost("http://www.vichitr.com/birdle/registerDevice.php");

        try {
            // Add your data
            List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(3);
            nameValuePairs.add(new BasicNameValuePair("id", regid));
            nameValuePairs.add(new BasicNameValuePair("email", getEmail(context)));
            nameValuePairs.add(new BasicNameValuePair("name", getDeviceName()));
